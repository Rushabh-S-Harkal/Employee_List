...
import 'package:employee_records/utils.dart';
...
class _IndexedListViewState extends State<IndexedListView> {
  ...
  Map<String, int> _getAlphabetDyPositions(List<Employee> items) {
  ...
  Widget _alphabeticalIndex(BuildContext context, List<Employee> items) {
